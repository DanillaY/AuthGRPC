...
func (c *authClient) Register(ctx context.Context, in *RegRequest, opts ...grpc.CallOption) (*RegResponse, error) {
	out := new(RegResponse)
...
func (UnimplementedAuthServer) Register(context.Context, *RegRequest) (*RegResponse, error) {
...
func _Auth_Register_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).Register(ctx, req.(*RegRequest))
	}
...
var Auth_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto_models/server.proto",
}
